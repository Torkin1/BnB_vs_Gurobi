...
class Solver_Test(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.params = [
            (53, SPTFRuleScheduler(), CompletionsSum(), SingleMachineScheduling(deepcopy(jobs), Machine(0))),
            (53, CombinatorialBnB(SPTFRuleScheduler), CompletionsSum(), SingleMachineScheduling(deepcopy(jobs), Machine(0))),
